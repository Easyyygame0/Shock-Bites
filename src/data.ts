...
export const PRODUCTS: Product[] = [
  ...
  { id: 11, name: "Kiwi Fruitee",              category: "Fruitees",       price: 69,  image: "Images/Fruitees.png",                    description: "Refreshing kiwi-based tea drink.",
    variants: [{ label: "Size", options: [{ name: "16oz", price: 69 }, { name: "22oz", price: 79 }] }] },
  { id: 12, name: "Strawberry Fruitee",        category: "Fruitees",       price: 69,  image: "Images/Fruitees.png",                    description: "Refreshing strawberry-based tea drink.",
    variants: [{ label: "Size", options: [{ name: "16oz", price: 69 }, { name: "22oz", price: 79 }] }] },
  { id: 13, name: "Mango Fruitee",             category: "Fruitees",       price: 69,  image: "Images/Fruitees.png",                    description: "Refreshing mango-based tea drink.",
    variants: [{ label: "Size", options: [{ name: "16oz", price: 69 }, { name: "22oz", price: 79 }] }] },
  { id: 14, name: "Lychee Fruitee",            category: "Fruitees",       price: 69,  image: "Images/Fruitees.png",                    description: "Refreshing lychee-based tea drink.",
    variants: [{ label: "Size", options: [{ name: "16oz", price: 69 }, { name: "22oz", price: 79 }] }] },
];

export const COMBOS = [
  { id: 101, name: "Savor & Sip Combo",       price: 189, description: "1pc Sproutarma paired with refreshing Fruitees",                              image: "Images/savor-and-sip-combo.png" },
  ...
  { id: 103, name: "Savor & Sip Trio",        price: 259, description: "1pc Sproutarma paired with refreshing Fruitees",                              image: "Images/savor-and-sip-trio.png" },
