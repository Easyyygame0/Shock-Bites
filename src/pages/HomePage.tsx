  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, #d4f53c 1px, transparent 1px)",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full py-16 sm:py-24 relative z-10">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-wider leading-none uppercase mb-5 sm:mb-7 text-white">
              Bold.
              <br />
              <span style={{ color: "#d4f53c" }}>Fresh.</span>
              <br />
              Unforgettable.
            </h1>

            <p
              className="text-base sm:text-lg font-semibold mb-8 max-w-md leading-relaxed"
              style={{ color: "rgba(255,255,255,0.75)" }}
            >
              Filipino snack flavors reimagined. Every bite surprises — made for
              people who refuse to settle for ordinary.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-end justify-between mb-8 sm:mb-10">
          <div>
            ...
            <h2
              className="font-display text-4xl sm:text-5xl md:text-6xl tracking-wider uppercase leading-none"
              style={{ color: "#1e5c2e" }}
            >
              Must Try
            </h2>
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="p-5 flex items-center justify-between">
                <div>
                  <h3
                    className="font-display text-xl tracking-wider uppercase leading-tight"
                    style={{ color: "#1a3a1a" }}
                  >
                    {item.name}
                  </h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 pt-6 sm:pt-8">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            ...
            <div
              className="space-y-4 font-semibold text-base sm:text-lg leading-relaxed"
              style={{ color: "rgba(255,255,255,0.75)" }}
            >
              <p>
                Shock Bites is a snack-focused food business that delivers bold,
                innovative flavors designed to surprise consumers with every
                bite. The company focuses on offering unique flavors through the
                ...
                customer appeal and brand identity.
              </p>
              <p>
                In order to achieve growth, this company plans on employing
                certain marketing initiatives, including customer engagement
                activities online and elsewhere. It hopes to build a reputation
                that attracts returning customers and loyal customers. Growth
                and sustainability are possible through constant product
                innovations, solid branding efforts, and satisfied customers.
              </p>
            </div>
            <p
              className="font-display text-xl sm:text-2xl tracking-wider uppercase mt-7"
              style={{ color: "#d4f53c" }}
            >
          ...
          <div
            ...
            style={{ border: "3px solid rgba(212,245,60,0.3)" }}
          >
            <video
              className="w-full"
              controls
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h2
          className="font-display text-4xl sm:text-5xl md:text-6xl tracking-wider uppercase mb-4"
          style={{ color: "#1e5c2e" }}
        >
          Find Us
        </h2>
        <p
          className="text-base sm:text-lg font-semibold mb-10"
          style={{ color: "#5a7a4a" }}
        >
        ...
        <div
          className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-sm border-2"
          style={{ borderColor: "#d4f53c" }}
        >
          <h3
            className="font-display text-2xl sm:text-3xl tracking-wider mb-5"
            style={{ color: "#1e5c2e" }}
          >
            FOLLOW US
          </h3>
          <div className="flex justify-center gap-3 flex-wrap">
            {[
              {
                href: "https://www.tiktok.com/@shockbites7",
                emoji: "🎵",
                platform: "TikTok",
                handle: "@shockbites7",
              },
              {
                href: "https://www.instagram.com/ShockBites11",
                emoji: "📸",
                platform: "Instagram",
                handle: "ShockBites11",
              },
              {
                href: "https://www.facebook.com/ShockBites",
                emoji: "👥",
                platform: "Facebook",
                handle: "ShockBites",
              },
